...
sealed class AppRoutes(val route: String) {
    ...
    data object Saved : AppRoutes(
        "saved?imagePath={imagePath}&isForPassport={isForPassport}&countryId={countryId}&documentType={documentType}&isForBgRemover={isForBgRemover}&isForSuitChanger={isForSuitChanger}"
    ) {
        const val ARG_IMAGE_PATH = "imagePath"
        const val ARG_IS_FOR_PASSPORT = "isForPassport"
        const val ARG_COUNTRY_ID = "countryId"
        ...
        const val ARG_IS_FOR_SUIT_CHANGER = "isForSuitChanger"
        ...
        fun createRoute(
            ...
            isForSuitChanger: Boolean = false
        ): String {
            return "saved" +
