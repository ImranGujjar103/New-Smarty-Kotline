...
data class SplashProAdConfig(
    ...
    @SerializedName("inter_id") val interIdPro: String =if (BuildConfig.DEBUG){"ca-app-pub-3940256099942544/1033173712"} else{  ""},
    @SerializedName("appopen_id") val appOpenIdPro: String = if (BuildConfig.DEBUG){"ca-app-pub-3940256099942544/9257395921"} else{ ""}
